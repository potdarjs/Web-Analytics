...
credentials <- OAuthFactory$new(consumerKey='xxxxxxxxxxxxxxxxxxxxxx',
...
tweetsby <- userTimeline('LoveKatrinaKaif',n=1000) # tweets from a user
head(tweetsby)

#-------------------------------------------------------------------------------
# Tweets containing Deepika Padukone-------------
tweetson <- searchTwitter("LoveKatrinaKaif", n=25)
tweetson
...
# Tweets containing Deepika Padukone-------------
tweetson <- searchTwitter("LoveKatrinaKaif", n=1000)
tweetson
